...
switch (_var) do
{
	...
	case "life_inv_bottledbeer": {"Seidel Bier"}; //alc -GT-
	// Added austrian food -GT-
	case "life_inv_leberk": {"Leberkäsesemmel"};
	case "life_inv_krapfen": {"Krapfen"};
	case "life_inv_frankfurter": {"Paar Frankfurter"};
	case "life_inv_krainer": {"Käsekrainer"};
	case "life_inv_manner": {"Mannerschnitten"};
	...
	case "license_civ_press": {"Presseausweis"};
