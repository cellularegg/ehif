...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_I_C_Soldier_Para_2_F",nil,16000],
			["U_I_C_Soldier_Para_3_F",nil,16000],
			["U_I_C_Soldier_Para_4_F",nil,16000],
			["U_I_C_Soldier_Para_1_F",nil,16000],
			["U_I_C_Soldier_Camo_F",nil,16000],
			["U_O_CombatUniform_ocamo",nil,17500],
			["U_O_CombatUniform_oucamo",nil,17500],
			["U_B_CTRG_Soldier_urb_2_F",nil,18000],
