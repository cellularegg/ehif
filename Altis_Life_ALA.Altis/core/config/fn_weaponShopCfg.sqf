			...
			default
			{
				["Inspektor Shop",
					[
						...
						["arifle_SPAR_01_blk_F",nil,45000],
			...
			default
			{
				["Hauptmann Shop",
					[
						...
						["arifle_SPAR_03_blk_F",nil,95000],
		...
		switch(true) do
		{
			...
			default
			{
				["Mohammed's Jihadi Shop",
					[
						["hgun_Pistol_01_F",nil,8000],
						["10Rnd_9x21_Mag",nil,40],
						...
						["arifle_TRG20_F",nil,78000],
						["arifle_Mk20_F",nil,80000],
						["arifle_Mk20C_F",nil,78000],
						["30Rnd_556x45_Stanag",nil,200],
						["arifle_CTAR_blk_F",nil,90000],
						["30Rnd_580x42_Mag_F",nil,250],
						["arifle_Katiba_F",nil,150000],
						["arifle_Katiba_C_F",nil,148000],
						["30Rnd_65x39_caseless_green",nil,275],
						["arifle_AKM_F",nil,175000],
						["30Rnd_762x39_Mag_F",nil,300],
						["srifle_DMR_01_F",nil,190000],
						["10Rnd_762x54_Mag",nil,500],
						["srifle_DMR_06_olive_F",nil,240000],
						["srifle_EBR_F",nil,250000],
						["srifle_DMR_03_F",nil,270000],
						["srifle_DMR_03_khaki_F",nil,280000],
						["srifle_DMR_03_tan_F",nil,280000],
						["srifle_DMR_03_multicam_F",nil,280000],
						["srifle_DMR_03_woodland_F",nil,280000],
						["20Rnd_762x51_Mag",nil,500],
						["srifle_DMR_02_F",nil,700000],
						["srifle_DMR_02_camo_F",nil,710000],
						["srifle_DMR_02_sniper_F",nil,710000],
						["10Rnd_338_Mag",nil,700],
						["srifle_LRR_F",nil,850000],
						["srifle_LRR_camo_F",nil,860000],
			...
			default
			{
				["Das Stammspieler Geschäft",
					[
						...
						["20Rnd_556x45_UW_mag",nil,100],
						["30Rnd_556x45_Stanag",nil,200],
						["arifle_AKS_F",nil,50000],
						["30Rnd_545x39_Mag_F",nil,100],
						["arifle_TRG21_F",nil,65000],
						["arifle_TRG20_F",nil,60000],
						["arifle_Mk20_F",nil,65000],
						["arifle_Mk20C_F",nil,60000],
						["30Rnd_556x45_Stanag",nil,200],
						["arifle_CTAR_blk_F",nil,80000],
						["30Rnd_580x42_Mag_F",nil,250],
						["arifle_Katiba_F",nil,130000],
						["arifle_Katiba_C_F",nil,120000],
						["30Rnd_65x39_caseless_green",nil,275],
						["arifle_AKM_F",nil,165000],
						["30Rnd_762x39_Mag_F",nil,300],
						["srifle_DMR_01_F",nil,175000],
						["10Rnd_762x51_Mag",nil,500],
						["srifle_DMR_06_olive_F",nil,220000],
						["srifle_EBR_F",nil,230000],
						["srifle_DMR_03_F",nil,250000],
						["srifle_DMR_03_khaki_F",nil,260000],
						["srifle_DMR_03_tan_F",nil,260000],
						["srifle_DMR_03_multicam_F",nil,260000],
						["srifle_DMR_03_woodland_F",nil,260000],
						["20Rnd_762x51_Mag",nil,500],
						["srifle_DMR_02_F",nil,650000],
						["srifle_DMR_02_camo_F",nil,660000],
						["srifle_DMR_02_sniper_F",nil,660000],
						["10Rnd_338_Mag",nil,700],
						["srifle_LRR_F",nil,800000],
						["srifle_LRR_camo_F",nil,810000],
						["7Rnd_408_Mag",nil,1000],
						["SmokeShell",nil,7000],
