...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "bottledbeer": {"life_inv_bottledbeer"}; // alc -GT-
			// Added austrian food -GT-
			case "leberk": {"life_inv_leberk"};
			case "krapfen": {"life_inv_krapfen"};
			case "frankfurter": {"life_inv_frankfurter"};
			case "krainer": {"life_inv_krainer"};
			case "manner": {"life_inv_manner"};
			case "almdudler": {"life_inv_almdudler"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_bottledbeer": {"bottledbeer"}; // alc -GT-
			// Added austrian food -GT-
			case "life_inv_leberk": {"leberk"};
			case "life_inv_krapfen": {"krapfen"};
			case "life_inv_frankfurter": {"frankfurter"};
			case "life_inv_krainer": {"krainer"};
			case "life_inv_manner": {"manner"};
			case "life_inv_almdudler": {"almdudler"};
