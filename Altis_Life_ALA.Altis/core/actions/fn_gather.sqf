...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","milk_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["milk_1"]): {_gather = "milk"; _val = 2;};
	default {""};
};
//gather check??
