...
[[format["%1 raubt gerade eine Tankstelle %2 aus! Kummans schnell!",name player,_shop],"Anonymer Zeuge",1],"clientMessage",true,false] spawn life_fnc_MP; // print shop - what does it show? roleName vs varName vs type
[[format["%1 raubt gerade eine Tankstelle %2 aus! Kummans schnell!",name player,_shop],"Anonymer Zeuge",1],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
//[[0,format["ALARM! - Gasstation: %1 is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
_shop playMove "AmovPercMstpSsurWnonDnon";
