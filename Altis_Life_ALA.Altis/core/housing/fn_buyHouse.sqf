...
{
	if(count life_houses >= 10) exitWith {hint format[localize "STR_House_Max_House",__GETC__(life_houseLimit)]};
	closeDialog 0;
};
...
if(_action) then {
	...
	[] call SOCK_fnc_updateRequest; // in case he wants to disconnect now...
