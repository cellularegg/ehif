...
if((_vInfo select 1) == "cop" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","B_MRAP_01_hmg_F","I_MRAP_03_F","B_Quadbike_01_F"]) then
{
	[[_vehicle,"cop_offroad",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

if((_vInfo select 1) == "med" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_F","C_Hatchback_01_sport_F","B_MRAP_01_hmg_F","I_MRAP_03_F","C_Van_01_box_F"]) then
{
	[[_vehicle,"med_offroad",true],"life_fnc_vehicleAnimate",_unit,false] spawn life_fnc_MP;
};

// GT: No thermals for civilians! //
if (_side == civilian) then{
	_vehicle disableTIEquipment true;
	[[_vehicle],"life_fnc_restrictSling",_unit,false] spawn life_fnc_MP;
};
