...
#define Btn6 37455
#define Btn7 37456
#define Btn8 37457 //breathalyze -GT-
#define Title 37401
...
if(!((player distance (getMarkerPos "police_hq_1") < 50) OR  (player distance (getMarkerPos "police_hq_2") < 50) OR (player distance (getMarkerPos "cop_spawn_3") < 50) OR (player distance (getMarkerPos "cop_spawn_4") < 50) OR (player distance (getMarkerPos "cop_spawn_5") < 50) OR (player distance (getMarkerPos "cobra_basis") < 50))) then 
{
