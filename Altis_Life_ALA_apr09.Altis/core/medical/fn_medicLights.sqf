...
switch (typeOf _vehicle) do {
	...
	case "I_MRAP_03_hmg_F": { _attach = [[-0.85,2.2,-0.75], [0.85,2.2,-0.75]]; };
	case "I_MRAP_03_F": { _attach = [[-0.85,2.2,-0.75], [0.85,2.2,-0.75]]; };	
	case "B_APC_Wheeled_01_cannon_F": { _attach = [[-1, -2.8, 0.55], [1, -2.8, 0.55]]; };	
	case "B_MRAP_01_hmg_F": { _attach = [[-0.50,1.5,-0.68], [0.50,1.5,-0.68]]; };
	case "B_MRAP_01_F": { _attach = [[-0.50,1.5,-0.68], [0.50,1.5,-0.68]]; };
	case "B_Quadbike_01_F": { _attach = [[-0.45, 0.0, 0.56], [0.35, 0.0, 0.56]]; };
	case "C_Van_01_box_F": { _attach = [[-0.2, 2.3, -0.35], [0.2, 2.3, -0.35]]; };
};
